...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex">
            <div class="flex-none">
                <img src="https://image.tmdb.org/t/p/w300//vkoSSVrGxFYvtr2uUdz99ENXF1v.jpg" alt="parasite"
                     class="w-96">
            ...
            <div class="ml-24">
                <h2 class="text-4xl font-semibold">Ana de Armas</h2>
                <div class="flex items-center text-gray-400 text-sm">
                    ...
                    <span class="ml-2">Apr 30, 1988 (34 years old) in Toronto, Canada Santa Cruz del Norte, Cuba</span>
                </div>
                <p class="text-gray-300 mt-8">
                    Ana de Armas was born in Cuba on April 30, 1988. At the age of 14, she began her studies at the
                    National Theatre School of Havana, where she graduated after 4 years. She made her film debut with
                    Una rosa de Francia (2006), which was directed by Manuel Gutiérrez Aragón. In 2006 she moved to
                    Spain where she continued her film career, and started doing television. She currently lives between
                    Madrid and Barcelona. Ana is known for her roles in Blade Runner 2049 (2017), Knives Out (2019), and
                    No Time to Die (2021).
                </p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                    ...
                    <div class="mt-4">
                        <a href="#"><img
                                    src="https://image.tmdb.org/t/p/w185/jOgbnL5FB30pprEjZaY1E1iPtPM.jpg"
                                    alt="poster"
                                    class="hover:opacity-75 transition ease-in-out duration-150"></a>
                        <a href="#"
                           class="text-sm leading-normal block text-gray-400 hover:text-white mt-1">Blonde</a>
                    </div>
    ...
    <div class="credits border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            <ul class="list-disc leading-loose pl-5 mt-8">
                ...
                <li>2022 · <strong>Blonde</strong>
                    as Norma Jeane
                </li>
                <li>2022 · <strong>The Gray Man</strong>
                    as Dani Miranda
                </li>
                <li>2022 · <strong>Deep Water</strong>
