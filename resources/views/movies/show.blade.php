                                                ...
                                                <div class="text-center">
                                                    ...
                                                    @else
                                                        <div class="items-center text-gray-400 text-sm mt-12 mb-2">
                                                            <p>
                                                                <a class="text-lg font-normal text-gray-500 dark:text-gray-400 hover:text-orange-500 transition ease-in-out duration-200"
                                                                   href="{{ route('create-your-list.create') }}">Create
                                                                    your first
                                                                    list.</a></p>
                                                            <p><small class="text-gray-500 dark:text-gray-400">Create a
                                                                    list so you
